...
public class BDSimulado {
	...
	public BDSimulado(){
		...
		Usuario u1 = new Usuario("561", "João", "Masculino", 55);
		Usuario u2 = new Usuario("345", "José", "Masculino", 18);
		Usuario u3 = new Usuario("852", "Adão", "Masculino", 35);
	...
	//Metodo que dá avaliacao a um filme
